...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "🟣 <b>Purple Digital Store ငွေဖြည့် Bot မှ ကြိုဆိုပါတယ်</b> 🎉\n\n"
        "စတင်ရန်၊ သင့် Website အသုံးပြုသူအမည်ကို ပေးပို့ပါ။\n\n"
...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "topup":
        ...
        await query.edit_message_text(
            ...
            "📱 09451266782\n"
            "👤 Mya Sandar\n\n"
            "💡 ငွေချေပြီးပါက ငွေပမာဏ (ဥပမာ 4000) သို့မဟုတ် 📸 Screenshot ပေးပို့ပါ။",
            parse_mode="HTML",
        )
...
async def payment_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.photo:
        ...
        await update.message.reply_text(
            ...
            "📸 ဓာတ်ပုံ (screenshot) လက်ခံပြီး Admin သို့ auto-forward ပြုလုပ်ပြီးပါပြီ။",
            parse_mode="HTML"
        )
        return
